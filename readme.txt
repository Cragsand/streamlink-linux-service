...
# Download and install ffmpeg - we use the global linux system one to keep it updated
sudo apt update
...
# Get your token from inspecting cookies in your browser on Twitch. This is required if you want to record during ad breaks.
[Settings]
...
# Give permission to read and write in path - Replace crag with your username

sudo chown -R crag:crag /home/crag/streamlink/logs

# These might also be needed - Replace crag with your username
