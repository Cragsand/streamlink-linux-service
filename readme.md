...
- In the example belo we install the script in your user home directory **/home/crag/streamlink** and set up a python environment in **/home/crag/streamlink/venv** and for the user **crag**.
