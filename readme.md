...
- You have to set up an [APP with the Twitch API](https://dev.twitch.tv/console/apps) and use your own account token for this to not record ads. Twitch embeds ads into the stream, this is the only way to avoid this happening.
